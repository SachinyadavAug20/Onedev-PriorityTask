                ...
                <div>
                    ...
                    <div className={`z-1111 ${dropdown ? "" : " hidden "} bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-44 relative right-0`}>
                        <ul className="p-2 text-sm text-body font-medium" >
                            <li>
                                <button className="inline-flex cursor-pointer items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Will do tommorow</button>
                            </li>
                            <li>
                                <button className="inline-flex cursor-pointer items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Settings</button>
                            </li>
                            <li>
                                <button className="inline-flex cursor-pointer items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Earnings</button>
                            </li>
                        </ul>
                        <div className="p-2 text-sm text-body font-medium border-t border-default-medium">
                            <button className="inline-flex cursor-pointer items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Separated link</button>
                        </div>
                    </div>
                </div>
            </div>
