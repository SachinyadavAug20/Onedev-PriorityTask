                        ...
                        <div className="SIGN_IN_BBTN flex gap-2 sm:gap-5">
                            <div className="flex flex-col sm:flex-row items-center p-1 w-fit h-fit bg-slate-700 text-white rounded-md shadow-lg">
                                <Link href={`/dashboard/${session.user.name.split(" ")[0]}`}>
                                    <section className="flex justify-center items-center w-8 h-8 sm:w-10 sm:h-10 rounded-full shadow-md bg-linear-to-r from-[#F9C97C] to-[#A2E9C1] hover:from-[#C9A9E9] hover:to-[#7EE7FC] hover:cursor-pointer hover:scale-110 duration-300">
                                ...
                                <section className="block sm:border-l border-gray-300 mx-2 sm:mx-3 my-1">
                                    <div className="pl-2 sm:pl-3 text-center sm:text-left">
                                        <h3 className="text-gray-200 font-semibold text-xs sm:text-sm">{session.user.name}</h3>
                                        <h3 className="bg-clip-text text-transparent bg-linear-to-l from-sky-300 to-blue-600 text-xs font-bold">{session.user.email}</h3>
                                    </div>
                                </section>
