        ...
        <div className="">
            <div className={`flex justify-between border-t-0 px-2 sm:px-3 lg:px-5 bg-white/30 backdrop-blur-md border-2 rounded-t-none border-gray-700/50 rounded-lg text-black py-1 sm:py-2 shadow-lg`}>
                ...
                <div className="flex items-center gap-10">
                    ...
                    {session &&
                        <div className="SIGN_IN_BBTN flex gap-5">
                            <div className="flex items-center p-1 w-fit h-fit bg-slate-700 text-white rounded-md shadow-lg">
                                ...
                                <section className="block border-l border-gray-300 mx-3 my-1">
                                    <div className="pl-3">
                                        <h3 className="text-gray-200 font-semibold text-sm">{session.user.name}</h3>
