    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-2 gap-0 sm:gap-0 px-2 sm:px-3 lg:px-5 pb-[34vh] sm:pb-6 lg:pb-10 pt-1 sm:pt-2 sm:grid-rows-2 min-h-[80vh] sm:h-auto overflow-y-auto sm:overflow-visible">
                <div className="bg-yellow-500 border-0 rounded-xl rounded-br-none h-[30vh] sm:h-[37vh] lg:h-[35vh] mb-2 sm:mb-0">
                ...
                <div className="bg-green-500 border-0 rounded-xl flex flex-col rounded-bl-none justify-between h-[30vh] sm:h-[37vh] lg:h-[35vh] mb-2 sm:mb-0">
                ...
                <div className="bg-gray-500 border-0 rounded-xl flex flex-col rounded-tr-none justify-between h-[30vh] sm:h-[37vh] lg:h-[35vh] mb-2 sm:mb-0">
                ...
                <div className="bg-orange-500 border-0 rounded-xl rounded-tl-none flex flex-col justify-between h-[30vh] sm:h-[37vh] lg:h-[35vh] mb-2 sm:mb-0">
