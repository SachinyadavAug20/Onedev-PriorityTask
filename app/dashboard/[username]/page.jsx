                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white/20 backdrop-blur-md rounded-xl p-6 shadow-lg border border-white/20 hover:bg-white/15 transition-all duration-200">
                        ...
                        <div className="space-y-2">
                            <p className="text-gray-700">Total Tasks: <span className="font-bold text-shadow-lg/30 text-blue-800">{stats.totalTasks}</span></p>
                            <p className="text-gray-700">Tasks Completed: <span className="font-bold text-shadow-lg/30 text-green-800">{stats.completedTasks}</span></p>
                            <p className="text-gray-700">Tasks Pending: <span className="font-bold text-shadow-lg/30 text-orange-800">{stats.pendingTasks}</span></p>
                            <p className="text-gray-700">Productivity Score: <span className="font-bold text-shadow-lg/30 text-purple-800">{stats.productivityScore}%</span></p>
                        </div>
                    </div>
